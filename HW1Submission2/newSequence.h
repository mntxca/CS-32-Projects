...
public:
    ...
    Sequence(int itemCount); //for newSequence
    ~Sequence(); //destructor
    Sequence(const Sequence& other); //copy constructor
    Sequence& operator=(const Sequence& rhs); // = operator overload
...
private:
    int objCount; //keeps track of how many objects there are in the array
    int capacity;
    ItemType* arr;
};

#endif // for newSequence_H
